...
import { getAuthorizedWorkPdfUrl } from "@/lib/workPdfAccess";

const KEY = "work:posts";

export const dynamic = "force-dynamic";

async function getPdfUrl(url: string | undefined): Promise<string | null> {
  try {
    const postsData = await kv.get<unknown>(KEY);
    return getAuthorizedWorkPdfUrl(url, postsData);
  } catch {
    return null;
  }
}
